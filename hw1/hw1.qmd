...
```
This method is not 100% accurate since if the word appears twice or more in one line, the count will still be 1. However, it could give us an overview of the frequency of each word appears in the book.
...
Both of them will store `"hello, world"` into a text file. For the first one, 
